...
from_dir = "C:/Users/vitor/Downloads/Aula_111/PRO_1-1_C102_AtividadeDoAluno1-main"
to_dir = "C:/Users/vitor/Downloads/Aula_111/PRO_1-1_C102_AtividadeDoAluno1-main"
...
for file_name in list_of_files:
    ...
    if extension in ['.pdf']:
        ...
        path2 = to_dir + '/' + "pdf"                   # Exemplo path2 : D:/Meus Arquivos/Arquivos_Imagem      
        path3 = to_dir + '/' + "pdf" + '/' + file_name # Exemplo path3 : D:/Meus Arquivos/Arquivos_Imagem/nomeImagem1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
